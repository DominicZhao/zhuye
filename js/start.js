...
$(function(){
    $(".word1").lbyl({
        content: "<p>你好！我叫<strong>赵泽民</strong>欢迎来到我的个人主页，希望在这里能对我有初步的认识，这里汇聚了我的部分具有代表性的小技术，希望能留下宝贵的<strong>意见</strong></p>",
        speed: 60,
        type: 'show'
    ...
    dianji.addEventListener("mousedown",function(){
        isMouseDown = true;
        initializeVariables()
        diyiye.css("transform"," scale(0,0)")
    })
